...
const formations7ASide: FormationConfig[] = [
  ...
  },
  {
    ...
    positions: [
      ...
      { position: "Striker Left", x: 30, y: 20 },
      { position: "Striker Right", x: 70, y: 20 }
    ]
  }
];
...
const formations11ASide: FormationConfig[] = [
  ...
  },
  {
    ...
    positions: [
      ...
      { position: "Defender Centre Right", x: 70, y: 70 },
      { position: "Defender Right", x: 90, y: 70 },
      { position: "Midfielder Centre Left", x: 25, y: 45 },
      { position: "Midfielder Centre", x: 50, y: 45 },
      { position: "Midfielder Centre Right", x: 75, y: 45 },
      { position: "Attacking Midfielder Left", x: 15, y: 20 },
      { position: "Striker Centre", x: 50, y: 15 },
      { position: "Attacking Midfielder Right", x: 85, y: 20 }
    ]
  }
];
