...
export default function ResetPasswordMobile() {
  ...
  if (!isValidToken) {
    return (
      <div className="safe-area-root min-h-dvh ios-wallpaper-twilight flex flex-col items-center justify-center p-6">
  ...
  // Password reset form
  return (
    <div className="safe-area-root min-h-dvh ios-wallpaper-twilight flex flex-col p-6">
