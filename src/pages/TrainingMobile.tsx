    ...
    >
      <div className="p-4 space-y-4">
        ...
        {todaysSession && (
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium px-2.5 py-1 rounded-full bg-white/[0.06] text-primary">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full pt-2">
          <TabsList className="grid w-full grid-cols-3 ios-card border-0 p-1">
            <TabsTrigger value="library" className="text-xs text-white/70 data-[state=active]:bg-white/[0.06] data-[state=active]:text-primary">
              <BookOpen className="w-4 h-4 mr-1" />
              Library
            </TabsTrigger>
            <TabsTrigger value="plans" className="text-xs text-white/70 data-[state=active]:bg-white/[0.06] data-[state=active]:text-primary">
              <Users className="w-4 h-4 mr-1" />
              Plans
            </TabsTrigger>
            <TabsTrigger value="sessions" className="text-xs text-white/70 data-[state=active]:bg-white/[0.06] data-[state=active]:text-primary">
