    ...
    Tables: {
        ...
        Relationships: [
          {
            ...
            isOneToOne: false
            referencedRelation: "player_profiles"
            referencedColumns: ["team_staff_id"]
          },
          {
            foreignKeyName: "coaching_badges_staff_id_fkey"
            columns: ["staff_id"]
      ...
      event_invitations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "event_invitations_staff_id_fkey"
            columns: ["staff_id"]
            isOneToOne: false
            referencedRelation: "player_profiles"
            referencedColumns: ["team_staff_id"]
    ...
    Views: {
      all_user_roles: {
        Row: {
          ...
          linked_player_team_id: string | null
